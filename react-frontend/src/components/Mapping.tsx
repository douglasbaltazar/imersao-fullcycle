...
const googleMapsLoader = new Loader(process.env.REACT_APP_GOGLE_API_KEY);
        ...
        (event: FormEvent) => {
            ...
            try {
                ...
                if (error instanceof RouteExistsError) {
                    enqueueSnackbar(
                        `${route?.title} já adicionado, esperar finalizar.`,
                        {
                            variant: "error",
                        }
                    );
            ...
            // mapRef.current?.addRoute(routeIdSelected, { currentMarkerOptions: { }, endMarkerOptions: {}})
        },
        ...
        <Grid container className={classes.root}>
            <Grid item xs={12} sm={3}>
                ...
                <form onSubmit={startRoute} className={classes.form}>
                    ...
                    <Box className={classes.btnSubWrapper}>
                        <Button
                            type="submit"
                            variant="contained"
                            color="primary"
            ...
            <Grid item xs={12} sm={9}>
                <Box id="map" className={classes.map}></Box>
            </Grid>
        </Grid>
    );
};
